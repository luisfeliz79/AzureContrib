        ...
        if ($grant.Scope) {
            $grant.Scope.Split(" ") | Where-Object { $_ } | ForEach-Object {
                ...
                $grantDetails =  [ordered]@{
                    ...
                    "ClientPublisher"=(GetObjectByObjectId -ObjectId $grant.ClientId).publisherName
                    "ResourceObjectId" = $grant.ResourceId
                    "ResourceObjectName"=(GetObjectByObjectId -ObjectId $grant.ResourceId).DisplayName
                    "Permission" = $scope
                    "ConsentType" = $grant.ConsentType
                    "PrincipalObjectId" = $grant.PrincipalId
                    "ResourcePublisher"=(GetObjectByObjectId -ObjectId $grant.ResourceId).publisherName
                }
    ...
    $script:ObjectByObjectClassId['ServicePrincipal'].GetEnumerator() | ForEach-Object { $i = 0 } {
        ...
        | Where-Object { $_.PrincipalType -eq "ServicePrincipal" } | ForEach-Object {
            ...
            $grantDetails = [ordered]@{
                ...
                "Publisher"=(GetObjectByObjectId -ObjectId $grant.ResourceId).publisherName
            }
